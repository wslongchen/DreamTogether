...
public class StatusExpandAdapter extends BaseExpandableListAdapter {
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		...
		if(oneList.get(groupPosition).getTwoList().get(0).isIsfinished()){
			holder.group_tiao.setBackgroundColor(context.getResources().getColor(R.color.dreamYellow));
		}else{
			holder.group_tiao.setBackgroundColor(context.getResources().getColor(R.color.dramGrey));
		}
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView,
		...
		if(entity.isIsfinished()){
			viewHolder.tiao.setBackgroundColor(context.getResources().getColor(R.color.dreamYellow));
		}else{
			viewHolder.tiao.setBackgroundColor(context.getResources().getColor(R.color.dramGrey));
		}
