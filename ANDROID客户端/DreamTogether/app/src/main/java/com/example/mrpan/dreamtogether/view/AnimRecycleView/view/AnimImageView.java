...
public class AnimImageView extends ImageView {
    ...
    public void draw(Canvas canvas) {
        ...
        if (getLayoutParams().height > dp1) {
            ...
            //canvas.drawBitmap(BitmapUtils.drawableToBitmap(getResources().getDrawable(R.mipmap.refresh7)),centerX - textWidth*2+10, 80,mPaint);
            // 矩形
...
//            }
            ...
            if (height >= maxHeight) {
                ...
                invalidate();
                canvas.drawBitmap(BitmapUtils.drawableToBitmap(getResources().getDrawable(R.mipmap.refresh1)), centerX - textWidth * 2 + 10, 80, mPaint);
                //canvas.drawText("松手刷新", centerX - textWidth, 50, mPaintText);
            } else {
