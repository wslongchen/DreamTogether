...
public class WaterDropListView extends ListView implements AbsListView.OnScrollListener,WaterDropListViewHeader.IStateChangedListener{
    ...
    private Scroller mScroller; // 滑动事件回滚
    private OnScrollListener mScrollListener; //滑动事件监听
...
//	private int mReadyHeight; // view由stretch变成ready的高度
    private final static int SCROLL_DURATION = 400; // 滑动间隔
    private final static int PULL_LOAD_MORE_DELTA = 50; //当下拉超过50px的时候
    // 加载更多
    private final static float OFFSET_RADIO = 1.8f; // 类似ios的下拉
    ...
    public WaterDropListView(Context context, AttributeSet attrs, int defStyleAttr) {
