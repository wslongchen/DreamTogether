...
public class RecordButton extends Button  {
	...
	private static final int MIN_INTERVAL_TIME = 1*1000;
	public final static int MAX_TIME = 60*1000 + 500;
	private final String  SAVE_PATH = Config.SAVE_SOUND_PATH;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		y = event.getY();
		if(y<0)
			view.setImageResource(R.mipmap.mic_cancel);
