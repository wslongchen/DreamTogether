...
+ 消息记录，通讯模块采用asmark.jar基于xmpp协议完成。注册之后可以与任意发表梦想的小伙伴进行聊天，支持语音，文件，文字，图片。并且基于此模块实现了简单的应用推送功能。
+ 
<img src="https://github.com/wslongchen/DreamTogether/blob/master/截图/Screenshot_20160612-160037.png" width="260px" height="480px"/>
+ 系统界面。可以进行拨号，关于界面采用加载h5页面显示。
+ 
